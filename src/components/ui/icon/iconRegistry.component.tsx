 ...
 * import { ApplicationProvider, IconRegistry, Layout, Text, Icon, Button } from '@ui-cat/components';
 * import { EvaIconsPack } from '@ui-cat/eva-icons'; // <-- Make sure it is installed. npm i @ui-cat/eva-icons
 *
