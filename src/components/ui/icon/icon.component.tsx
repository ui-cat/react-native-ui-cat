...
// In general, could be SVGProps if using @ui-cat/eva-icons or ImageProps if using Image.
 ...
 * In case of using `@ui-cat/eva-icons` package, Icon accepts any props for react-native-svg component.
 *
